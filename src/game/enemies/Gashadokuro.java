 ...
 *
 */
public class Gashadokuro extends Enemies implements Resettable {
    RunesManager runesManager = RunesManager.getInstance();
    ResetManager resetManager = ResetManager.getInstance();


    public Gashadokuro() {
        super("Gashadokuro", 'が', 569); //102
    ...
    public IntrinsicWeapon getIntrinsicWeapon() {
        return new IntrinsicWeapon(1000, "wacks", 10);
    }
    public int dropRunes(){
        return RandomNumberGenerator.getRandomInt(1000, 2500);
    }
